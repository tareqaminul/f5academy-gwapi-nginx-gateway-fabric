...
<mark>A *migration guide* for this option is available [here](https://docs.nginx.com/nginx-ingress-controller/install/migrate-ingress-nginx/) and also, for *production grade migration*, please explore - the Interactive YAML analysis, 130+ annotation mappings, and CRD migration examples [here](https://alessfg.github.io/nginx-ingress-migration-guide/#migration) and *ingress2gateway* tool by [kubernetes-sigs](https://github.com/kubernetes-sigs/ingress2gateway) with [example usage](https://alessfg.github.io/nginx-ingress-migration-guide/#i2g). </mark>
